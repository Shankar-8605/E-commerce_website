    ...
    <div class="wrapper">
        ...
        <form action=""method="POST" enctype="multipart/form-data">
            ...
            <tr>
                    <td>category_id:</td>
                    <td>
                        <input type="number" name="category_id" placeholder="Category_id Of The Food">
                    </td>
                </tr>
                <tr>
                    <td>Title:</td>
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
               ...
               // $sql="INSERT INTO `admin` ( `title`, `price`, `description`, `image_name`,`featured`,`active`) VALUES
                //( $title, $price, $description,$image_name,$)";
