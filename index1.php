<?php include('partials_front/menu.php');?>
    ...
    <section id="home">
        <h1 style="color:aquamarine">Always Choose Good</h1>
        <h1 class="h-primary" style="color:aquamarine">We serve The BEST</h1>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                                    ...
                                                    <?php
                                                        ...
                                                        {
                                                            ?>
                                                                <img class="cat_image" src="<?php echo SITEURL; ?>images/category/<?php echo $image_name; ?>"  alt="pizza" width="85%" >
                                                            <?php
                                                        }
                                                    ?>
                         ...
                         <div class="food-menu-box">
                            <div class="food-menu-img">
                                ...
                                <div class="food-menu-desc">
                                    ...
                                    <p class="food-price "><?php echo "Price : " . $price;?></p>
